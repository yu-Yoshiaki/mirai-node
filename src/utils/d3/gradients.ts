...
export const createGradients = (defs: Selection<any, any, any, any>) => {
  ...
  const animate = pulseFilter.append('animate')
  ...
  const suggestionGradient = defs.append('radialGradient')
  ...
  suggestionGradient.append('stop')
    .attr('offset', '0%')
